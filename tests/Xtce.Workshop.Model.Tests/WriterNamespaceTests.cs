...
public class WriterNamespaceTests
{
    ...
    public void Write_OutputReloadsToTheSameModelWithNoDiagnostics()
    {
        ...
        // The preserved Header and AlgorithmSet still resolve into the XTCE namespace.
        Assert.True(reloaded.Document.Preserved!.Any(f => f.ElementName == "Header"));
        Assert.True(reloaded.Document.TelemetryMetaData.Preserved!.Any(f => f.ElementName == "AlgorithmSet"));
    }
